...
distancia_berenjena = math.sqrt(
    (fruta_usuario[0] - berenjena[0])**2 +
    (fruta_usuario[1] - berenjena[1])**2 +
    (fruta_usuario[2] - berenjena[2])**2
)
...
st.write(" Berenjena:", distancia_berenjena)
